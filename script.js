...
const PRODUCTS = [
  ...
  { name: "Wild Mocha", file: "Wild_Mocha.jfif", sizes: "Length- Long, Shape- Stiletto, Size- Medium", price: 1200, cat: "bold", desc: ""A fierce mocha-toned set with a hand-drawn tiger design and animal stripe accent for a wild, statement-making finish." }
];
